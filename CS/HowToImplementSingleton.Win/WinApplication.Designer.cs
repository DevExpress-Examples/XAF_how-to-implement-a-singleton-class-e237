namespace HowToImplementSingleton.Win {
	partial class HowToImplementSingletonWindowsFormsApplication {
		...
		private void InitializeComponent() {
			...
			this.module4 = new HowToImplementSingleton.Module.Win.HowToImplementSingletonWindowsFormsModule();
			...
			// sqlConnection1
			// 
			this.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=HowToImplementSingleton;Integrated Security=SSPI;Pooling=false";
		...
		private HowToImplementSingleton.Module.Win.HowToImplementSingletonWindowsFormsModule module4;
